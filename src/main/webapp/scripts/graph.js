class Printer{
    ...
    drawPoints(r1) {
        ...
        $('#outputTable tr').each(function () {
            ...
            dots.push({
                ...
                "success": row.find("td:eq(3)").text() == "Hit",
    ...
    clickPoint(event) {
        ...
        sendReq(x.toFixed(3), y.toFixed(3), coords.selectedR);
        location.reload();
    }
}